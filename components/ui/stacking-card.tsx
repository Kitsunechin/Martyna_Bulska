...
export const Card = ({
  ...
  if (!isClient) {
    return (
      ...
      >
        <div
          className={`flex flex-col relative -top-[25%] h-[450px] w-[70%] rounded-2xl p-8 md:p-12 origin-top bg-card border border-border backdrop-blur-sm`}
          style={{ top: `calc(-5vh + ${i * 25}px)` }}
        >
          <div className={`flex h-full mt-6 gap-10`}>
